...
from hexable.types.hexable_types.codegen.methods.newsfeed import \
    NewsfeedCategory  # type: ignore
from hexable.types.hexable_types.objects import BaseUserGroupFields
from hexable.types.hexable_types.responses.newsfeed import (
    NewsfeedSearchExtendedResponse, NewsfeedSearchExtendedResponseModel,
    NewsfeedSearchExtendedStrictResponse,
    NewsfeedSearchExtendedStrictResponseModel, NewsfeedSearchResponse,
    NewsfeedSearchResponseModel, NewsfeedSearchStrictResponse,
