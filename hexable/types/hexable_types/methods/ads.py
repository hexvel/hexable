...
from hexable.types.hexable_types.codegen.methods.ads import \
    AdsCategory  # type: ignore
from hexable.types.hexable_types.responses.ads import (
    AdsGetSuggestionsCitiesResponse, AdsGetSuggestionsRegionsResponse,
    AdsGetSuggestionsResponse, AdsGetSuggestionsSchoolsResponse,
    AdsTargSuggestions, AdsTargSuggestionsCities, AdsTargSuggestionsRegions,
