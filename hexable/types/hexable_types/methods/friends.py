...
from hexable.types.hexable_types.codegen.methods.friends import \
    FriendsCategory  # type: ignore
from hexable.types.hexable_types.objects import (FriendsMutualFriend,
                                                 FriendsOnlineUsers,
                                                 FriendsOnlineUsersWithMobile,
                                                 UsersFields)
from hexable.types.hexable_types.responses.friends import (
    FriendsGetMutualResponse, FriendsGetMutualTargetUidsResponse,
    FriendsGetMutualTotalCountResponse, FriendsGetOnlineExtendedResponse,
    FriendsGetOnlineOnlineMobileExtendedResponse,
    FriendsGetOnlineOnlineMobileResponse,
    FriendsGetOnlineOnlineMobileResponseModel, FriendsGetOnlineResponse,
    FriendsGetRequestsExtendedResponse,
    FriendsGetRequestsExtendedResponseModel,
    FriendsGetRequestsNeedMutualResponse,
    FriendsGetRequestsNeedMutualResponseModel, FriendsGetRequestsResponse,
    FriendsGetRequestsResponseModel, FriendsMutualFriend, FriendsOnlineUsers,
    FriendsOnlineUsersWithMobile)
...
class FriendsCategory(FriendsCategory):
    ...
    async def get_mutual(
        ...
        **kwargs: typing.Any,
        ...
        "FriendsMutualFriend", typing.List[int], typing.List[FriendsMutualFriend]
    ]:
