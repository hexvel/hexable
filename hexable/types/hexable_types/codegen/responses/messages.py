...
from hexable.types.hexable_types.objects import (
    GroupsGroupFull, MessagesChat, MessagesChatFull, MessagesChatPreview,
    MessagesConversation, MessagesConversationWithMessage,
    MessagesDeleteFullResponseItem, MessagesGetConversationById,
    MessagesGetConversationByIdExtended, MessagesGetConversationMembers,
    MessagesGetInviteLinkByOwnerResponseItem, MessagesHistoryAttachment,
    MessagesLastActivity, MessagesLongpollMessages, MessagesLongpollParams,
    MessagesMessage, MessagesMessagesArray, MessagesPinnedMessage,
    MessagesReactionAssetItem, MessagesReactionCounterResponseItem,
    MessagesReactionCountersResponseItem, MessagesReactionResponseItem,
    MessagesSendUserIdsResponseItem, UsersUser, UsersUserFull)
...
class MessagesGetLongPollHistoryResponseModel(BaseModel):
    history: typing.Optional[typing.List[typing.List[typing.Union["str", "int"]]]] = (
        Field(
            default=None,
        )
    )
