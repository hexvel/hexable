...
from hexable.types.hexable_types.objects import (VideoLiveCategory,
                                                 VideoSaveResult,
                                                 VideoVideoAlbumFull)
from hexable.types.hexable_types.responses.base import (BaseBoolResponse,
                                                        BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.video import *  # noqa: F401,F403  # type: ignore
...
class VideoCategory(BaseCategory):
    async def add(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("video.add", params)
    ...
    async def add_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.addAlbum", params)
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.createComment", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.delete", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.deleteAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.deleteComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.edit", params)
    ...
    async def edit_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.editAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.editComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.get", params)
    ...
    async def get_album_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.getAlbumById", params)
    ...
    async def get_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.getAlbums", params)
    ...
    async def get_albums_by_video(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.getAlbumsByVideo", params)
        model = self.get_model(
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.getComments", params)
        model = self.get_model(
    ...
    async def get_long_poll_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.getLongPollServer", params)
    ...
    async def live_get_categories(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.liveGetCategories", params)
    ...
    async def reorder_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.reorderAlbums", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_videos(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.reorderVideos", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.report", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.reportComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.restoreComment", params)
    ...
    async def save(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.save", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.search", params)
        model = self.get_model(
    ...
    async def start_streaming(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.startStreaming", params)
    ...
    async def stop_streaming(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.stopStreaming", params)
    ...
    async def unpin_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("video.unpinComment", params)
        model = BaseOkResponse
        return model(**response).response
