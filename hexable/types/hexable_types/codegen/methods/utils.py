...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.utils import *  # noqa: F401,F403  # type: ignore
...
class UtilsCategory(BaseCategory):
    async def check_link(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("utils.checkLink", params)
    ...
    async def delete_from_last_shortened(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("utils.deleteFromLastShortened", params)
    ...
    async def get_last_shortened_links(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("utils.getLastShortenedLinks", params)
    ...
    async def get_link_stats(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("utils.getLinkStats", params)
    ...
    async def get_short_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("utils.getShortLink", params)
    ...
    async def resolve_screen_name(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("utils.resolveScreenName", params)
