...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.board import *  # noqa: F401,F403  # type: ignore
...
class BoardCategory(BaseCategory):
    async def add_topic(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("board.addTopic", params)
    ...
    async def close_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.closeTopic", params)
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.createComment", params)
    ...
    async def delete_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.deleteComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.deleteTopic", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.editComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.editTopic", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def fix_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.fixTopic", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.getComments", params)
    ...
    async def get_topics(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.getTopics", params)
        model = self.get_model(
    ...
    async def open_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.openTopic", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.restoreComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unfix_topic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("board.unfixTopic", params)
        model = BaseOkResponse
        return model(**response).response
