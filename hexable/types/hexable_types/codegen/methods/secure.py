...
from hexable.types.hexable_types.responses.secure import *  # noqa: F401,F403  # type: ignore
...
class SecureCategory(BaseCategory):
    async def add_app_event(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("secure.addAppEvent", params)
    ...
    async def check_token(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.checkToken", params)
    ...
    async def get_app_balance(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.getAppBalance", params)
    ...
    async def get_smshistory(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.getSMSHistory", params)
    ...
    async def get_transactions_history(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.getTransactionsHistory", params)
    ...
    async def get_user_level(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.getUserLevel", params)
    ...
    async def give_event_sticker(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.giveEventSticker", params)
    ...
    async def send_notification(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.sendNotification", params)
    ...
    async def send_smsnotification(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("secure.sendSMSNotification", params)
        model = BaseOkResponse
        return model(**response).response
