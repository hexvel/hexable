...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.stories import *  # noqa: F401,F403  # type: ignore
...
class StoriesCategory(BaseCategory):
    async def ban_owner(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("stories.banOwner", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.delete", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.get", params)
    ...
    async def get_banned(
        ...
        **kwargs: typing.Any,
        ...
        StoriesGetBannedResponseModel, StoriesGetBannedExtendedResponseModel
    ]:
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getBanned", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getById", params)
    ...
    async def get_detailed_stats(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getDetailedStats", params)
    ...
    async def get_photo_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getPhotoUploadServer", params)
    ...
    async def get_replies(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getReplies", params)
        model = StoriesGetV5113Response
        return model(**response).response
    ...
    async def get_stats(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getStats", params)
    ...
    async def get_video_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getVideoUploadServer", params)
    ...
    async def get_viewers(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.getViewers", params)
        model = self.get_model(
    ...
    async def hide_all_replies(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.hideAllReplies", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def hide_reply(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.hideReply", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def save(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.save", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.search", params)
        model = StoriesGetV5113Response
        return model(**response).response
    ...
    async def send_interaction(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.sendInteraction", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unban_owner(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("stories.unbanOwner", params)
        model = BaseOkResponse
        return model(**response).response
