...
from hexable.types.hexable_types.objects import NotificationsSendMessageItem
from hexable.types.hexable_types.responses.base import BaseBoolResponse
from hexable.types.hexable_types.responses.notifications import *  # noqa: F401,F403  # type: ignore
...
class NotificationsCategory(BaseCategory):
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("notifications.get", params)
    ...
    async def mark_as_viewed(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("notifications.markAsViewed", params)
    ...
    async def send_message(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("notifications.sendMessage", params)
