...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.status import *  # noqa: F401,F403  # type: ignore
...
class StatusCategory(BaseCategory):
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("status.get", params)
    ...
    async def set(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("status.set", params)
