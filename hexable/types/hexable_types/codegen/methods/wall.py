...
from hexable.types.hexable_types.responses.base import (BaseBoolResponse,
                                                        BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.wall import *  # noqa: F401,F403  # type: ignore
...
class WallCategory(BaseCategory):
    async def check_copyright_link(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("wall.checkCopyrightLink", params)
    ...
    async def close_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.closeComments", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.createComment", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.delete", params)
    ...
    async def delete_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.deleteComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.edit", params)
    ...
    async def edit_ads_stealth(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.editAdsStealth", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.editComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.get", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.getById", params)
        model = self.get_model(
    ...
    async def get_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.getComment", params)
        model = self.get_model(
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.getComments", params)
        model = self.get_model(
    ...
    async def get_reposts(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.getReposts", params)
    ...
    async def open_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.openComments", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def parse_attached_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.parseAttachedLink", params)
    ...
    async def pin(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.pin", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def post(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.post", params)
    ...
    async def post_ads_stealth(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.postAdsStealth", params)
    ...
    async def report_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.reportComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report_post(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.reportPost", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def repost(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.repost", params)
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.restoreComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.search", params)
        model = self.get_model(
    ...
    async def unpin(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("wall.unpin", params)
        model = BaseOkResponse
        return model(**response).response
