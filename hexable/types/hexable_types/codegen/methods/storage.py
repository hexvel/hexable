...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.storage import *  # noqa: F401,F403  # type: ignore
...
class StorageCategory(BaseCategory):
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("storage.get", params)
    ...
    async def get_keys(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("storage.getKeys", params)
    ...
    async def set(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("storage.set", params)
