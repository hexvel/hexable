...
class PollsCategory(BaseCategory):
    async def add_vote(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("polls.addVote", params)
    ...
    async def create(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.create", params)
    ...
    async def delete_vote(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.deleteVote", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.edit", params)
    ...
    async def get_backgrounds(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.getBackgrounds", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.getById", params)
    ...
    async def get_photo_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.getPhotoUploadServer", params)
    ...
    async def get_voters(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.getVoters", params)
    ...
    async def save_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("polls.savePhoto", params)
