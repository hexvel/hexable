...
from hexable.types.hexable_types.objects import BaseUploadServer, DocsDoc
from hexable.types.hexable_types.responses.base import (
    BaseGetUploadServerResponse, BaseOkResponse, BaseOkResponseModel)
from hexable.types.hexable_types.responses.docs import *  # noqa: F401,F403  # type: ignore
...
class DocsCategory(BaseCategory):
    async def add(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("docs.add", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.delete", params)
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.edit", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.get", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.getById", params)
    ...
    async def get_messages_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.getMessagesUploadServer", params)
    ...
    async def get_types(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.getTypes", params)
    ...
    async def get_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.getUploadServer", params)
        model = DocsGetUploadServerResponse
        return model(**response).response
    ...
    async def get_wall_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.getWallUploadServer", params)
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def save(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.save", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("docs.search", params)
