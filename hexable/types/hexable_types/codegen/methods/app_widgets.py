...
from hexable.types.hexable_types.objects import (AppWidgetsPhoto,
                                                 AppWidgetsPhotos)
from hexable.types.hexable_types.responses.app_widgets import *  # noqa: F401,F403  # type: ignore
...
class AppWidgetsCategory(BaseCategory):
    async def get_app_image_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("appWidgets.getAppImageUploadServer", params)
    ...
    async def get_app_images(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.getAppImages", params)
    ...
    async def get_group_images(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.getGroupImages", params)
    ...
    async def get_images_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.getImagesById", params)
    ...
    async def save_app_image(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.saveAppImage", params)
    ...
    async def save_group_image(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.saveGroupImage", params)
    ...
    async def update(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("appWidgets.update", params)
