...
from hexable.types.hexable_types.objects import (AddressFields,
                                                 BaseUserGroupFields,
                                                 GroupsAddress,
                                                 GroupsCallbackSettings,
                                                 GroupsFields, GroupsFilter,
                                                 GroupsGroupFull,
                                                 GroupsGroupTag,
                                                 GroupsLinksItem,
...
from hexable.types.hexable_types.responses.base import (BaseBoolResponse,
                                                        BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.groups import *  # noqa: F401,F403  # type: ignore
...
class GroupsCategory(BaseCategory):
    async def add_address(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("groups.addAddress", params)
    ...
    async def add_callback_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.addCallbackServer", params)
    ...
    async def add_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.addLink", params)
    ...
    async def approve_request(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.approveRequest", params)
    ...
    async def ban(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.ban", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def create(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.create", params)
    ...
    async def delete_address(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.deleteAddress", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_callback_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.deleteCallbackServer", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.deleteLink", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def disable_online(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.disableOnline", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.edit", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_address(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.editAddress", params)
    ...
    async def edit_callback_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.editCallbackServer", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.editLink", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_manager(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.editManager", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def enable_online(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.enableOnline", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.get", params)
    ...
    async def get_addresses(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getAddresses", params)
    ...
    async def get_banned(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getBanned", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getById", params)
    ...
    async def get_callback_confirmation_code(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getCallbackConfirmationCode", params)
    ...
    async def get_callback_servers(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getCallbackServers", params)
    ...
    async def get_callback_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getCallbackSettings", params)
    ...
    async def get_catalog_info(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getCatalogInfo", params)
        model = self.get_model(
    ...
    async def get_invited_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getInvitedUsers", params)
    ...
    async def get_invites(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getInvites", params)
        model = self.get_model(
    ...
    async def get_long_poll_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getLongPollServer", params)
    ...
    async def get_long_poll_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getLongPollSettings", params)
    ...
    async def get_online_status(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getOnlineStatus", params)
    ...
    async def get_requests(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getRequests", params)
        model = self.get_model(
    ...
    async def get_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getSettings", params)
    ...
    async def get_tag_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getTagList", params)
    ...
    async def get_token_permissions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.getTokenPermissions", params)
    ...
    async def invite(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.invite", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def join(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.join", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def leave(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.leave", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def remove_user(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.removeUser", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.reorderLink", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.search", params)
    ...
    async def set_callback_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.setCallbackSettings", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_long_poll_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.setLongPollSettings", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.setSettings", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_user_note(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.setUserNote", params)
    ...
    async def tag_add(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.tagAdd", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def tag_bind(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.tagBind", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def tag_delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.tagDelete", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def tag_update(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.tagUpdate", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def toggle_market(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.toggleMarket", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unban(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("groups.unban", params)
        model = BaseOkResponse
        return model(**response).response
