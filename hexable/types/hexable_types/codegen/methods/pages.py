...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.pages import *  # noqa: F401,F403  # type: ignore
...
class PagesCategory(BaseCategory):
    async def clear_cache(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("pages.clearCache", params)
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.get", params)
    ...
    async def get_history(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.getHistory", params)
    ...
    async def get_titles(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.getTitles", params)
    ...
    async def get_version(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.getVersion", params)
    ...
    async def parse_wiki(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.parseWiki", params)
    ...
    async def save(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.save", params)
    ...
    async def save_access(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("pages.saveAccess", params)
