...
from hexable.types.hexable_types.objects import (
    BaseUserGroupFields, MessagesChat, MessagesChatFull,
    MessagesGetConversationById, MessagesGetConversationByIdExtended,
    MessagesGetConversationMembers, MessagesLastActivity,
    MessagesLongpollParams, MessagesPinnedMessage, UsersFields)
from hexable.types.hexable_types.responses.base import (BaseBoolResponse,
                                                        BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.base_response import DictResponse
from hexable.types.hexable_types.responses.messages import *  # noqa: F401,F403  # type: ignore
...
class MessagesCategory(BaseCategory):
    async def add_chat_user(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("messages.addChatUser", params)
    ...
    async def add_chat_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.addChatUsers", params)
    ...
    async def allow_messages_from_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.allowMessagesFromGroup", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def create_chat(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.createChat", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.delete", params)
    ...
    async def delete_chat_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.deleteChatPhoto", params)
    ...
    async def delete_conversation(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.deleteConversation", params)
    ...
    async def delete_reaction(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.deleteReaction", params)
    ...
    async def deny_messages_from_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.denyMessagesFromGroup", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.edit", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def edit_chat(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.editChat", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get_by_conversation_message_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getByConversationMessageId", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getById", params)
        model = self.get_model(
    ...
    async def get_chat(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getChat", params)
        model = self.get_model(
            (
    ...
    async def get_chat_preview(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getChatPreview", params)
    ...
    async def get_conversation_members(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getConversationMembers", params)
    ...
    async def get_conversations(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getConversations", params)
    ...
    async def get_conversations_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getConversationsById", params)
        model = self.get_model(
    ...
    async def get_history(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getHistory", params)
        model = self.get_model(
    ...
    async def get_history_attachments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getHistoryAttachments", params)
    ...
    async def get_important_messages(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getImportantMessages", params)
        model = self.get_model(
    ...
    async def get_intent_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getIntentUsers", params)
    ...
    async def get_invite_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getInviteLink", params)
    ...
    async def get_last_activity(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getLastActivity", params)
    ...
    async def get_long_poll_history(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getLongPollHistory", params)
    ...
    async def get_long_poll_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getLongPollServer", params)
    ...
    async def get_messages_reactions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getMessagesReactions", params)
    ...
    async def get_reacted_peers(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getReactedPeers", params)
    ...
    async def get_reactions_assets(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.getReactionsAssets", params)
    ...
    async def is_messages_from_group_allowed(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.isMessagesFromGroupAllowed", params)
    ...
    async def join_chat_by_invite_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.joinChatByInviteLink", params)
    ...
    async def mark_as_answered_conversation(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.markAsAnsweredConversation", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def mark_as_important(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.markAsImportant", params)
    ...
    async def mark_as_read(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.markAsRead", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def mark_reactions_as_read(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.markReactionsAsRead", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def pin(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.pin", params)
    ...
    async def remove_chat_user(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.removeChatUser", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.search", params)
        model = self.get_model(
    ...
    async def search_conversations(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.searchConversations", params)
        model = self.get_model(
    ...
    async def send_message_event_answer(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.sendMessageEventAnswer", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def send_reaction(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.sendReaction", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def set_activity(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.setActivity", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_chat_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.setChatPhoto", params)
    ...
    async def unpin(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("messages.unpin", params)
        model = BaseOkResponse
        return model(**response).response
