...
from hexable.types.hexable_types.objects import (BaseCountry, DatabaseCityById,
                                                 DatabaseSchoolClass,
                                                 DatabaseStation)
from hexable.types.hexable_types.responses.database import *  # noqa: F401,F403  # type: ignore
...
class DatabaseCategory(BaseCategory):
    async def get_chairs(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("database.getChairs", params)
    ...
    async def get_cities(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getCities", params)
    ...
    async def get_cities_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getCitiesById", params)
    ...
    async def get_countries(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getCountries", params)
    ...
    async def get_countries_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getCountriesById", params)
    ...
    async def get_faculties(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getFaculties", params)
    ...
    async def get_metro_stations(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getMetroStations", params)
    ...
    async def get_metro_stations_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getMetroStationsById", params)
    ...
    async def get_regions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getRegions", params)
    ...
    async def get_school_classes(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getSchoolClasses", params)
    ...
    async def get_schools(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getSchools", params)
    ...
    async def get_universities(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("database.getUniversities", params)
