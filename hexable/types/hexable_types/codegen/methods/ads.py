...
from hexable.types.hexable_types.objects import (AdsAccount, AdsAd,
                                                 AdsAdLayout, AdsCampaign,
                                                 AdsClient, AdsCreateAdStatus,
                                                 AdsCreateCampaignStatus,
                                                 AdsCreateClientsStatus,
                                                 AdsDemoStats, AdsFloodStats,
                                                 AdsLinkStatus,
                                                 AdsPromotedPostReach,
                                                 AdsRejectReason, AdsStats,
                                                 AdsTargetGroup,
                                                 AdsTargetPixelInfo,
                                                 AdsTargSettings, AdsTargStats,
                                                 AdsTargSuggestions,
                                                 ...
                                                 AdsUsers)
from hexable.types.hexable_types.responses.ads import *  # noqa: F401,F403  # type: ignore
...
class AdsCategory(BaseCategory):
    async def add_office_users(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("ads.addOfficeUsers", params)
    ...
    async def check_link(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.checkLink", params)
    ...
    async def create_ads(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createAds", params)
    ...
    async def create_campaigns(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createCampaigns", params)
    ...
    async def create_clients(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createClients", params)
    ...
    async def create_lookalike_request(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createLookalikeRequest", params)
    ...
    async def create_target_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createTargetGroup", params)
    ...
    async def create_target_pixel(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.createTargetPixel", params)
    ...
    async def delete_ads(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.deleteAds", params)
    ...
    async def delete_campaigns(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.deleteCampaigns", params)
    ...
    async def delete_clients(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.deleteClients", params)
    ...
    async def delete_target_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.deleteTargetGroup", params)
    ...
    async def delete_target_pixel(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.deleteTargetPixel", params)
    ...
    async def get_accounts(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getAccounts", params)
    ...
    async def get_ads(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getAds", params)
    ...
    async def get_ads_layout(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getAdsLayout", params)
    ...
    async def get_ads_targeting(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getAdsTargeting", params)
    ...
    async def get_budget(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getBudget", params)
    ...
    async def get_campaigns(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getCampaigns", params)
    ...
    async def get_categories(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getCategories", params)
    ...
    async def get_clients(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getClients", params)
    ...
    async def get_demographics(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getDemographics", params)
    ...
    async def get_flood_stats(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getFloodStats", params)
    ...
    async def get_lookalike_requests(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getLookalikeRequests", params)
    ...
    async def get_musicians(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getMusicians", params)
    ...
    async def get_musicians_by_ids(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getMusiciansByIds", params)
        model = AdsGetMusiciansResponse
        return model(**response).response
    ...
    async def get_office_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getOfficeUsers", params)
    ...
    async def get_posts_reach(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getPostsReach", params)
    ...
    async def get_rejection_reason(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getRejectionReason", params)
    ...
    async def get_statistics(
        ...
        ids_type: str,
        period: str,
        stats_fields: typing.Optional[
            typing.List[typing.Literal["views_times"]]
        ] = None,
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getStatistics", params)
    ...
    async def get_suggestions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getSuggestions", params)
    ...
    async def get_target_groups(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getTargetGroups", params)
    ...
    async def get_target_pixels(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getTargetPixels", params)
    ...
    async def get_targeting_stats(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getTargetingStats", params)
    ...
    async def get_upload_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getUploadURL", params)
    ...
    async def get_video_upload_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.getVideoUploadURL", params)
    ...
    async def import_target_contacts(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.importTargetContacts", params)
    ...
    async def remove_office_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.removeOfficeUsers", params)
    ...
    async def remove_target_contacts(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.removeTargetContacts", params)
    ...
    async def save_lookalike_request_result(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.saveLookalikeRequestResult", params)
    ...
    async def share_target_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.shareTargetGroup", params)
    ...
    async def update_ads(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateAds", params)
    ...
    async def update_campaigns(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateCampaigns", params)
    ...
    async def update_clients(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateClients", params)
    ...
    async def update_office_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateOfficeUsers", params)
    ...
    async def update_target_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateTargetGroup", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def update_target_pixel(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("ads.updateTargetPixel", params)
        model = BaseUndefinedResponse
        return model(**response).response
