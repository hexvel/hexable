...
from hexable.types.hexable_types.objects import (BaseUploadServer, PhotosPhoto,
                                                 PhotosPhotoAlbumFull,
                                                 PhotosPhotoTag,
                                                 PhotosPhotoUpload,
                                                 UsersFields)
from hexable.types.hexable_types.responses.base import (
    BaseBoolResponse, BaseGetUploadServerResponse, BaseOkResponse,
    BaseOkResponseModel)
from hexable.types.hexable_types.responses.photos import *  # noqa: F401,F403  # type: ignore
...
class PhotosCategory(BaseCategory):
    async def confirm_tag(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("photos.confirmTag", params)
    ...
    async def copy(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.copy", params)
    ...
    async def create_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.createAlbum", params)
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.createComment", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.delete", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.deleteAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.deleteComment", params)
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.edit", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.editAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.editComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.get", params)
    ...
    async def get_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getAlbums", params)
    ...
    async def get_albums_count(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getAlbumsCount", params)
    ...
    async def get_all(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getAll", params)
    ...
    async def get_all_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getAllComments", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getById", params)
    ...
    async def get_chat_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getChatUploadServer", params)
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getComments", params)
    ...
    async def get_market_album_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getMarketAlbumUploadServer", params)
        model = BaseGetUploadServerResponse
        return model(**response).response
    ...
    async def get_market_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getMarketUploadServer", params)
    ...
    async def get_messages_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getMessagesUploadServer", params)
    ...
    async def get_new_tags(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getNewTags", params)
    ...
    async def get_owner_photo_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getOwnerPhotoUploadServer", params)
        model = BaseGetUploadServerResponse
        return model(**response).response
    ...
    async def get_tags(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getTags", params)
    ...
    async def get_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getUploadServer", params)
    ...
    async def get_user_photos(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getUserPhotos", params)
    ...
    async def get_wall_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.getWallUploadServer", params)
    ...
    async def make_cover(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.makeCover", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def move(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.move", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def put_tag(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.putTag", params)
    ...
    async def remove_tag(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.removeTag", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.reorderAlbums", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_photos(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.reorderPhotos", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.report", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.reportComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.restoreComment", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def save(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.save", params)
    ...
    async def save_market_album_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveMarketAlbumPhoto", params)
    ...
    async def save_market_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveMarketPhoto", params)
    ...
    async def save_messages_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveMessagesPhoto", params)
    ...
    async def save_owner_cover_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveOwnerCoverPhoto", params)
    ...
    async def save_owner_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveOwnerPhoto", params)
    ...
    async def save_wall_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.saveWallPhoto", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("photos.search", params)
