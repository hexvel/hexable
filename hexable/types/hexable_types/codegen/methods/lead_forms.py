...
from hexable.types.hexable_types.objects import LeadFormsForm
from hexable.types.hexable_types.responses.lead_forms import *  # noqa: F401,F403  # type: ignore
...
class LeadFormsCategory(BaseCategory):
    async def create(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("leadForms.create", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.delete", params)
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.get", params)
    ...
    async def get_leads(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.getLeads", params)
    ...
    async def get_upload_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.getUploadURL", params)
    ...
    async def list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.list", params)
    ...
    async def update(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("leadForms.update", params)
        model = LeadFormsCreateResponse
        return model(**response).response
