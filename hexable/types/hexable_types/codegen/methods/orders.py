...
from hexable.types.hexable_types.responses.orders import *  # noqa: F401,F403  # type: ignore
...
class OrdersCategory(BaseCategory):
    async def cancel_subscription(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("orders.cancelSubscription", params)
    ...
    async def change_state(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.changeState", params)
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.get", params)
    ...
    async def get_amount(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.getAmount", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.getById", params)
    ...
    async def get_user_subscription_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.getUserSubscriptionById", params)
    ...
    async def get_user_subscriptions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("orders.getUserSubscriptions", params)
