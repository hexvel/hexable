...
from hexable.types.hexable_types.responses.likes import *  # noqa: F401,F403  # type: ignore
...
class LikesCategory(BaseCategory):
    async def add(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("likes.add", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("likes.delete", params)
    ...
    async def get_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("likes.getList", params)
    ...
    async def is_liked(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("likes.isLiked", params)
