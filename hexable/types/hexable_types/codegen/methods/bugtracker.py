...
from hexable.types.hexable_types.responses.base import (
    ...
    BaseOkResponseModel)
from hexable.types.hexable_types.responses.bugtracker import *  # noqa: F401,F403  # type: ignore
...
class BugtrackerCategory(BaseCategory):
    async def add_company_groups_members(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("bugtracker.addCompanyGroupsMembers", params)
    ...
    async def add_company_members(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.addCompanyMembers", params)
    ...
    async def change_bugreport_status(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.changeBugreportStatus", params)
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.createComment", params)
    ...
    async def get_bugreport_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.getBugreportById", params)
    ...
    async def get_company_group_members(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.getCompanyGroupMembers", params)
    ...
    async def get_company_members(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.getCompanyMembers", params)
    ...
    async def get_download_version_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.getDownloadVersionUrl", params)
    ...
    async def get_product_build_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method(
            "bugtracker.getProductBuildUploadServer", params
        )
    ...
    async def remove_company_group_member(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.removeCompanyGroupMember", params)
    ...
    async def remove_company_member(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.removeCompanyMember", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def save_product_version(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.saveProductVersion", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_company_member_role(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.setCompanyMemberRole", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_product_is_over(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("bugtracker.setProductIsOver", params)
        model = BaseOkResponse
        return model(**response).response
