...
from hexable.types.hexable_types.responses.adsweb import *  # noqa: F401,F403  # type: ignore
...
class AdswebCategory(BaseCategory):
    async def get_ad_categories(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("adsweb.getAdCategories", params)
    ...
    async def get_ad_unit_code(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("adsweb.getAdUnitCode", params)
    ...
    async def get_ad_units(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("adsweb.getAdUnits", params)
    ...
    async def get_fraud_history(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("adsweb.getFraudHistory", params)
    ...
    async def get_sites(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("adsweb.getSites", params)
    ...
    async def get_statistics(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("adsweb.getStatistics", params)
