...
from hexable.types.hexable_types.objects import BaseUploadServer, UsersFields
from hexable.types.hexable_types.responses.base import (
    BaseBoolResponse, BaseGetUploadServerResponse, BaseOkResponse,
    BaseOkResponseModel)
from hexable.types.hexable_types.responses.market import *  # noqa: F401,F403  # type: ignore
...
class MarketCategory(BaseCategory):
    async def add(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("market.add", params)
    ...
    async def add_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.addAlbum", params)
    ...
    async def add_property(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.addProperty", params)
    ...
    async def add_property_variant(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.addPropertyVariant", params)
    ...
    async def add_to_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.addToAlbum", params)
    ...
    async def create_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.createComment", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.delete", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.deleteAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.deleteComment", params)
    ...
    async def delete_property(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.deleteProperty", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def delete_property_variant(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.deletePropertyVariant", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.edit", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.editAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.editComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_order(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.editOrder", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_property(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.editProperty", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_property_variant(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.editPropertyVariant", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def filter_categories(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.filterCategories", params)
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.get", params)
    ...
    async def get_album_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getAlbumById", params)
    ...
    async def get_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getAlbums", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getById", params)
        model = self.get_model(
    ...
    async def get_categories(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getCategories", params)
        model = MarketGetCategoriesNewResponse
        return model(**response).response
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getComments", params)
    ...
    async def get_group_orders(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getGroupOrders", params)
    ...
    async def get_order_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getOrderById", params)
    ...
    async def get_order_items(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getOrderItems", params)
    ...
    async def get_orders(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getOrders", params)
        model = self.get_model(
    ...
    async def get_product_photo_upload_server(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getProductPhotoUploadServer", params)
    ...
    async def get_properties(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.getProperties", params)
    ...
    async def group_items(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.groupItems", params)
    ...
    async def remove_from_album(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.removeFromAlbum", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_albums(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.reorderAlbums", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def reorder_items(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.reorderItems", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.report", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def report_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.reportComment", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.restore", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def restore_comment(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.restoreComment", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def save_product_photo(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.saveProductPhoto", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.search", params)
        model = self.get_model(
    ...
    async def search_items(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.searchItems", params)
    ...
    async def search_items_basic(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.searchItemsBasic", params)
    ...
    async def ungroup_items(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("market.ungroupItems", params)
        model = BaseOkResponse
        return model(**response).response
