...
from hexable.types.hexable_types.responses.base import (BaseBoolResponse,
                                                        BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.newsfeed import *  # noqa: F401,F403  # type: ignore
...
class NewsfeedCategory(BaseCategory):
    async def add_ban(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("newsfeed.addBan", params)
    ...
    async def delete_ban(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.deleteBan", params)
    ...
    async def delete_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.deleteList", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.get", params)
    ...
    async def get_banned(
        ...
        **kwargs: typing.Any,
        ...
        NewsfeedGetBannedExtendedResponseModel, NewsfeedGetBannedResponseModel
    ]:
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getBanned", params)
    ...
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getComments", params)
    ...
    async def get_lists(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getLists", params)
        model = self.get_model(
    ...
    async def get_mentions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getMentions", params)
    ...
    async def get_recommended(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getRecommended", params)
        model = NewsfeedGenericResponse
        return model(**response).response
    ...
    async def get_suggested_sources(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.getSuggestedSources", params)
    ...
    async def ignore_item(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.ignoreItem", params)
    ...
    async def save_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.saveList", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.search", params)
        model = self.get_model(
            (
    ...
    async def unignore_item(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.unignoreItem", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unsubscribe(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("newsfeed.unsubscribe", params)
        model = BaseOkResponse
        return model(**response).response
