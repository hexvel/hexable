...
from hexable.types.hexable_types.responses.widgets import *  # noqa: F401,F403  # type: ignore
...
class WidgetsCategory(BaseCategory):
    async def get_comments(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("widgets.getComments", params)
    ...
    async def get_pages(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("widgets.getPages", params)
