...
from hexable.types.hexable_types.objects import AsrTask, BaseUploadServer
from hexable.types.hexable_types.responses.asr import *  # noqa: F401,F403  # type: ignore
...
class AsrCategory(BaseCategory):
    async def check_status(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("asr.checkStatus", params)
    ...
    async def get_upload_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("asr.getUploadUrl", params)
    ...
    async def process(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("asr.process", params)
