...
from hexable.types.hexable_types.objects import UsersFields, UsersUserFull
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.users import *  # noqa: F401,F403  # type: ignore
...
class UsersCategory(BaseCategory):
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("users.get", params)
    ...
    async def get_followers(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("users.getFollowers", params)
    ...
    async def get_subscriptions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("users.getSubscriptions", params)
        model = self.get_model(
    ...
    async def report(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("users.report", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("users.search", params)
