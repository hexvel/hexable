...
from hexable.types.hexable_types.objects import (AppsAppFields,
                                                 AppsTestingGroup, UsersFields)
from hexable.types.hexable_types.responses.apps import *  # noqa: F401,F403  # type: ignore
...
class AppsCategory(BaseCategory):
    async def add_snippet(
        ...
        vk_ref: typing.Optional[
            typing.List[typing.Literal["snippet_im", "snippet_post"]]
        ] = None,
        **kwargs: typing.Any,
        ...
        response = await self.api.method("apps.addSnippet", params)
    ...
    async def add_users_to_testing_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.addUsersToTestingGroup", params)
    ...
    async def delete_app_requests(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.deleteAppRequests", params)
    ...
    async def delete_snippet(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.deleteSnippet", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.get", params)
    ...
    async def get_catalog(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getCatalog", params)
    ...
    async def get_friends_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getFriendsList", params)
    ...
    async def get_leaderboard(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getLeaderboard", params)
        model = self.get_model(
    ...
    async def get_mini_app_policies(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getMiniAppPolicies", params)
    ...
    async def get_scopes(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getScopes", params)
    ...
    async def get_score(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getScore", params)
    ...
    async def get_snippets(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getSnippets", params)
    ...
    async def get_testing_groups(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.getTestingGroups", params)
    ...
    async def is_notifications_allowed(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.isNotificationsAllowed", params)
    ...
    async def promo_has_active_gift(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.promoHasActiveGift", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def promo_use_gift(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.promoUseGift", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def remove_testing_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.removeTestingGroup", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def remove_users_from_testing_groups(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.removeUsersFromTestingGroups", params)
        model = BaseBoolResponse
        return model(**response).response
    ...
    async def send_request(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.sendRequest", params)
    ...
    async def update_meta_for_testing_group(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("apps.updateMetaForTestingGroup", params)
