...
from hexable.types.hexable_types.objects import PrettyCardsPrettyCardOrError
from hexable.types.hexable_types.responses.pretty_cards import *  # noqa: F401,F403  # type: ignore
...
class PrettyCardsCategory(BaseCategory):
    async def create(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("prettyCards.create", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("prettyCards.delete", params)
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("prettyCards.edit", params)
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("prettyCards.get", params)
    ...
    async def get_by_id(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("prettyCards.getById", params)
    ...
    async def get_upload_url(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("prettyCards.getUploadURL", params)
