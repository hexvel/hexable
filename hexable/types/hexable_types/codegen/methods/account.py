...
from hexable.types.hexable_types.objects import (AccountAccountCounters,
                                                 AccountInfo,
                                                 AccountPushSettings,
                                                 AccountUserSettings,
                                                 BaseUserGroupFields)
from hexable.types.hexable_types.responses.account import *  # noqa: F401,F403  # type: ignore
...
class AccountCategory(BaseCategory):
    async def ban(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("account.ban", params)
    ...
    async def change_password(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.changePassword", params)
    ...
    async def get_active_offers(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getActiveOffers", params)
    ...
    async def get_app_permissions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getAppPermissions", params)
    ...
    async def get_banned(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getBanned", params)
    ...
    async def get_counters(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getCounters", params)
    ...
    async def get_info(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getInfo", params)
    ...
    async def get_profile_info(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getProfileInfo", params)
    ...
    async def get_push_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.getPushSettings", params)
    ...
    async def register_device(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.registerDevice", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def save_profile_info(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.saveProfileInfo", params)
    ...
    async def set_info(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.setInfo", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_offline(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.setOffline", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_online(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.setOnline", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_push_settings(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.setPushSettings", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def set_silence_mode(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.setSilenceMode", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unban(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.unban", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def unregister_device(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("account.unregisterDevice", params)
        model = BaseOkResponse
        return model(**response).response
