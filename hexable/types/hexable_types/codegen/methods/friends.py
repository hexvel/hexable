...
from hexable.types.hexable_types.objects import (FriendsFriendExtendedStatus,
                                                 FriendsFriendStatus,
                                                 FriendsMutualFriend,
                                                 FriendsOnlineUsers,
...
from hexable.types.hexable_types.responses.base import (BaseOkResponse,
                                                        BaseOkResponseModel)
from hexable.types.hexable_types.responses.friends import *  # noqa: F401,F403  # type: ignore
...
class FriendsCategory(BaseCategory):
    async def add(
        ...
        **kwargs: typing.Any,
        ...
        response = await self.api.method("friends.add", params)
    ...
    async def add_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.addList", params)
    ...
    async def are_friends(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.areFriends", params)
    ...
    async def delete(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.delete", params)
    ...
    async def delete_all_requests(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.deleteAllRequests", params)
    ...
    async def delete_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.deleteList", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.edit", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def edit_list(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.editList", params)
        model = BaseOkResponse
        return model(**response).response
    ...
    async def get(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.get", params)
        model = self.get_model(
    ...
    async def get_app_users(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getAppUsers", params)
    ...
    async def get_lists(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getLists", params)
    ...
    async def get_mutual(
        ...
        **kwargs: typing.Any,
        ...
        typing.List[int], typing.List[FriendsMutualFriend], "FriendsMutualFriend"
    ]:
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getMutual", params)
        model = self.get_model(
            (
    ...
    async def get_recent(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getRecent", params)
    ...
    async def get_requests(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getRequests", params)
        model = self.get_model(
            (
    ...
    async def get_suggestions(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.getSuggestions", params)
    ...
    async def search(
        ...
        **kwargs: typing.Any,
        ...
        params = self.get_set_params(locals())
        response = await self.api.method("friends.search", params)
